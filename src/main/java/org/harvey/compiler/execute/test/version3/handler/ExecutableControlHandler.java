...
public interface ExecutableControlHandler {
    ...
    default void handleNext(ControlContext context, ExecutableControlHandler handler) {
        context.nowHandler(handler);
        beforeHandleNext(context);
        handler.handle(context);
        afterHandleNext(context);
    }

    default void beforeHandleNext(ControlContext context) {

    }

    default void afterHandleNext(ControlContext context) {
    ...
    default void nextIsIf(ControlContext context) {
        handleNext(context, context.ifHandler());
    }
