...
public class LocalVariableTableBuilder {
    ...
    public static final String INT8_T = "int8";
    public static final String INT16_T = "int16";
    public static final String INT32_T = "int32";
    public static final String INT64_T = "int64";
    // 出的时候吧后面的填好
