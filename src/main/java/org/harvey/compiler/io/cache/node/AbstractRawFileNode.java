 ...
 * @version 1.0
 * @date 2025-03-17 21:21
 */
public abstract class AbstractRawFileNode extends AbstractFileNode {

    protected AbstractRawFileNode(String simpleName, String[] fullname, File file) {
        super(simpleName, fullname, file, null);
    }

    protected AbstractRawFileNode(String simpleName, String joinedFullname, File file) {
        super(simpleName, joinedFullname, file, null);
    }

    protected AbstractRawFileNode(
            String simpleName,
            String[] fullname,
            File file,
